...
(
  ...
  COLLATE = utf8mb4_unicode_ci COMMENT = '成长值变化历史记录'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '积分变化历史记录'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 5
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '会员'
  ROW_FORMAT = Dynamic;
...
VALUES (1, 1, 'firenay', '$2a$10$uDXc05.IsjGI//f7HC8/lOGys0oRiFZX59olzqVqTl8IKxR8iBVGy', 'firenay', '18173516208',
        'xxx@gmail.com', NULL, 0, '2020-06-25', '湖南 长沙', 'JAVA', NULL, NULL, NULL, NULL, 0, '2020-06-25 13:09:14', NULL,
        NULL, NULL);
INSERT INTO `ums_member`
VALUES (2, 1, 'sentinel', '$2a$10$j5XRpUeGq7AYIFk7pqdvyebK.Bo5MvasCxk.8RuBWsHFcq5RzXKEC', 'sentinel', '18173516102',
        'xxx@gmail.com', NULL, 1, '2020-06-25', '湖南 长沙', 'JAVA', NULL, NULL, NULL, NULL, 0, '2020-06-25 13:15:33', NULL,
        NULL, NULL);
INSERT INTO `ums_member`
VALUES (3, 1, 'firenayfly', '$2a$10$UvvfpBagTqbalI6UTnq5nOiPheEdbKLO64fozWMx1lUeK9p2tM366', 'firenayfly', '18467894965',
        'xxx@gmail.com', NULL, 1, '2020-06-25', '湖南 长沙', 'JAVA', NULL, NULL, NULL, NULL, 0, '2020-06-25 13:18:32', NULL,
        NULL, NULL);
INSERT INTO `ums_member`
VALUES (4, 1, '汀西氟的我是你', '$2a$10$uDXc05.IsjGI//f7HC8/lOGys0oRiFZX59olzqVqTl8IKxR8iBVGy', '汀西氟的我是你', '18467894965',
        'xxx@gmail.com', NULL, 1, '2020-06-26', '湖南 长沙', '自媒体', NULL, NULL, NULL, NULL, 0, '2020-06-26 09:36:00',
        '5605937365', '2.00b5w4HGMwxc6B0e3d62c666DlN1DD', '157679999');
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '会员收藏的商品'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '会员收藏的专题活动'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 6
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '会员等级'
  ROW_FORMAT = Dynamic;
...
VALUES (1, '普通会员', 0, 1, 188.0000, 10, 0, 0, 1, '初级会员');
INSERT INTO `ums_member_level`
VALUES (2, '铜牌会员', 2000, 0, 159.0000, 20, 0, 1, 1, '铜牌会员');
INSERT INTO `ums_member_level`
VALUES (3, '银牌会员', 5000, 0, 129.0000, 50, 0, 1, 1, '银牌会员');
INSERT INTO `ums_member_level`
VALUES (4, '金牌会员', 8000, 0, 88.0000, 0, 1, 1, 1, '金牌会员');
INSERT INTO `ums_member_level`
VALUES (5, '钻石会员', 12000, 0, 48.0000, 80, 1, 1, 1, '钻石会员');
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '会员登录记录'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 4
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '会员收货地址'
  ROW_FORMAT = Dynamic;
...
VALUES (1, 1, 'firenay', '18173516208', NULL, '湖南', '长沙', NULL, '望城区', NULL, 1);
INSERT INTO `ums_member_receive_address`
VALUES (2, 2, 'sentinel', '18173516102', NULL, '湖南', '长沙', NULL, '雨花区', NULL, 1);
INSERT INTO `ums_member_receive_address`
VALUES (3, 3, 'firenayfly', '15421564125', NULL, '陕西', '西安', NULL, '新城区', NULL, 1);
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '会员统计信息'
  ROW_FORMAT = Dynamic;
